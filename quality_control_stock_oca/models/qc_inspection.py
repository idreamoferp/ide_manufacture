...
class QcInspection(models.Model):
    ...
    picking_id = fields.Many2one(comodel_name="stock.picking", compute="_compute_picking", store=True)
    lot_id = fields.Many2one( comodel_name="stock.lot", compute="_compute_lot", store=True)
