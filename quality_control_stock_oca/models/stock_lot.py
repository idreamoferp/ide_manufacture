...
class StockProductionLot(models.Model):
    ...
    qc_inspections_ids = fields.One2many(comodel_name="qc.inspection", inverse_name="lot_id", copy=False, string="Inspections", help="Inspections related to this lot.",)
    created_inspections = fields.Integer(compute="_compute_count_inspections", string="Created inspections")
    done_inspections = fields.Integer(compute="_compute_count_inspections", string="Done inspections")
    passed_inspections = fields.Integer(compute="_compute_count_inspections", string="Inspections OK")
    failed_inspections = fields.Integer(compute="_compute_count_inspections", string="Inspections failed")
